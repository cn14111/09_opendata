...
tmax is the highest temperature in the day
...
median is always close to the peak of the densityand not sensitive to outliers
...
fe_month <- fieldweather %>%
 ...
 mutate(month_abb = month(date, label = T))  # to know the abbreviated month
...
As month progress, we can see the shift
